 $(document).ready(function() {
	...
	$("#menu li").hover(function() {
		$(this).stop().animate({"background-color":"#333"}, 800);
	},function() {
		$(this).stop().animate({"background-color": "#0F1010" }, 800);
	});
	...
	$("#menu li:has(ul)").find("a:first").append(
		'&nbsp;&nbsp;<img src="catalog/view/theme/simply-minimal-black1-rounded/image/arrow-down.png" />'
	);
